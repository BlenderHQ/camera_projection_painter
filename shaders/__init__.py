...
class PreviewParams(StructUBO):transform:glsl_vec4;outline_color:glsl_vec4;aspect:glsl_vec2;roundness:glsl_float;outline_thickness:glsl_float;tile_index:glsl_int;_fields_=[(_J,glsl_vec4),(_K,glsl_vec4),('aspect',glsl_vec2),(_L,glsl_float),(_M,glsl_float),('tile_index',glsl_int),(_F,glsl_int),(_D,glsl_vec2)]
...
class UVProjectParams(StructUBO):camera_matrix:glsl_mat4;uv_texture_resolution:glsl_int;_fields_=('camera_matrix',glsl_mat4),('uv_texture_resolution',glsl_int),(_F,glsl_float),(_D,glsl_vec2)
