...
class RC_MetadataXMP_Params:rc_metadata_xmp_export_mode:EnumProperty(items=((RC_METADATA_XMP_ExportMode.DO_NOT_EXPORT.name,'Do Not Export',''),(RC_METADATA_XMP_ExportMode.DRAFT.name,'Draft',''),(RC_METADATA_XMP_ExportMode.EXACT.name,'Exact',''),(RC_METADATA_XMP_ExportMode.LOCKED.name,'Locked','')),default=RC_METADATA_XMP_ExportMode.DRAFT.name,options={_C},translation_context=_F,name=_G);rc_metadata_xmp_calibration_group:IntProperty(default=-1,min=-1,options={_C},translation_context=_B,name=_H,description='');rc_metadata_xmp_distortion_group:IntProperty(default=-1,min=-1,options={_C},translation_context=_B,name=_I,description='');rc_metadata_xmp_in_texturing:BoolProperty(default=_A,options={_C},translation_context=_B,name=_J);rc_metadata_xmp_in_meshing:BoolProperty(default=_A,options={_C},translation_context=_B,name=_K)
class RC_MetadataXMP_ExportParams:
	rc_metadata_xmp_overwrite_flags:EnumProperty(items=((RC_METADATA_XMP_Overwrite.rc_metadata_xmp_export_mode.name,_G,'',0,RC_METADATA_XMP_Overwrite.rc_metadata_xmp_export_mode.value),(RC_METADATA_XMP_Overwrite.rc_metadata_xmp_calibration_group.name,_H,'',0,RC_METADATA_XMP_Overwrite.rc_metadata_xmp_calibration_group.value),(RC_METADATA_XMP_Overwrite.rc_metadata_xmp_distortion_group.name,_I,'',0,RC_METADATA_XMP_Overwrite.rc_metadata_xmp_distortion_group.value),(RC_METADATA_XMP_Overwrite.rc_metadata_xmp_in_texturing.name,_J,'',0,RC_METADATA_XMP_Overwrite.rc_metadata_xmp_in_texturing.value),(RC_METADATA_XMP_Overwrite.rc_metadata_xmp_in_meshing.name,_K,'',0,RC_METADATA_XMP_Overwrite.rc_metadata_xmp_in_meshing.value)),default=set(),options={'HIDDEN','ENUM_FLAG'},translation_context=_D,name='Overwrite',description='What data to overwrite');rc_metadata_xmp_use_calibration_groups:BoolProperty(default=_A,translation_context=_D,name='Calibration Groups');rc_metadata_xmp_include_editor_options:BoolProperty(default=_A,translation_context=_D,name='Include Editor Options')
