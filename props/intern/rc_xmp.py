...
__all__='RC_METADATA_XMP_PosePrior','RC_METADATA_XMP_CalibrationPrior','RC_METADATA_XMP_Coordinates',_F,'RC_METADATA_XMP_Overwrite',_B,_D,'RC_MetadataXMP_Props','create_props_rc_rotation'
