...
if TYPE_CHECKING:from typing import TypeVar;RC_XYAltProps=TypeVar(_G,bound=PropertyGroup);RC_HeadingPitchRollProps=TypeVar(_B,bound=PropertyGroup);RC_OmegaPhiKappaProps=TypeVar(_C,bound=PropertyGroup);from..ob import ObjectProps;from.common import Float64ArrayT,LocationProps,RotationMatrixProps
...
def create_props_rc_xyalt()->RC_XYAltProps:
	...
	attr_name='x';_prop_single_T,_prop_double_T,_prop=double.property_group(attr_name,name='X',get=_x_remapped_to_negative_y_get,set=_x_remapped_to_negative_y_set);_annotations_dict[double.eval_prop_single_name(name=attr_name)]=_prop_single_T;_annotations_dict[double.eval_prop_double_name(name=attr_name)]=_prop_double_T;_properties_dict[attr_name]=_prop
	...
	attr_name='y';_prop_single_T,_prop_double_T,_prop=double.property_group(attr_name,name='Y',get=_y_remapped_to_x_get,set=_y_remapped_to_x_set);_annotations_dict[double.eval_prop_single_name(name=attr_name)]=_prop_single_T;_annotations_dict[double.eval_prop_double_name(name=attr_name)]=_prop_double_T;_properties_dict[attr_name]=_prop
	...
	attr_name=A;_prop_single_T,_prop_double_T,_prop=double.property_group(attr_name,name='Alt',get=_alt_remapped_to_z_get,set=_alt_remapped_to_z_set);_annotations_dict[double.eval_prop_single_name(name=attr_name)]=_prop_single_T;_annotations_dict[double.eval_prop_double_name(name=attr_name)]=_prop_double_T;_properties_dict[attr_name]=_prop
	...
	return type(_G,(PropertyGroup,),{_D:_annotations_dict,_E:_draw,_F:_impl_as_array,**_properties_dict})
def create_props_rc_hpr()->_B:
	...
	attr_name=A;_prop_single_T,_prop_double_T,_prop=double.property_group(attr_name,name='Heading',get=_heading_get,set=_heading_set,translation_context=_B);_annotations_dict[double.eval_prop_single_name(name=attr_name)]=_prop_single_T;_annotations_dict[double.eval_prop_double_name(name=attr_name)]=_prop_double_T;_properties_dict[attr_name]=_prop
	...
	attr_name=B;_prop_single_T,_prop_double_T,_prop=double.property_group(attr_name,name='Pitch',get=_pitch_get,set=_pitch_set,translation_context=_B);_annotations_dict[double.eval_prop_single_name(name=attr_name)]=_prop_single_T;_annotations_dict[double.eval_prop_double_name(name=attr_name)]=_prop_double_T;_properties_dict[attr_name]=_prop
	...
	attr_name=C;_prop_single_T,_prop_double_T,_prop=double.property_group(attr_name,name='Roll',get=_roll_get,set=_roll_set,translation_context=_B);_annotations_dict[double.eval_prop_single_name(name=attr_name)]=_prop_single_T;_annotations_dict[double.eval_prop_double_name(name=attr_name)]=_prop_double_T;_properties_dict[attr_name]=_prop
	...
	return type(_B,(PropertyGroup,),{_D:_annotations_dict,_E:_draw,_F:_impl_as_array,**_properties_dict})
def create_props_rc_opk()->_C:
	...
	attr_name=A;_prop_single_T,_prop_double_T,_prop=double.property_group(attr_name,name='Omega',get=_omega_get,set=_omega_set,translation_context=_C);_annotations_dict[double.eval_prop_single_name(name=attr_name)]=_prop_single_T;_annotations_dict[double.eval_prop_double_name(name=attr_name)]=_prop_double_T;_properties_dict[attr_name]=_prop
	...
	attr_name=B;_prop_single_T,_prop_double_T,_prop=double.property_group(attr_name,name='Phi',get=_phi_get,set=_phi_set,translation_context=_C);_annotations_dict[double.eval_prop_single_name(name=attr_name)]=_prop_single_T;_annotations_dict[double.eval_prop_double_name(name=attr_name)]=_prop_double_T;_properties_dict[attr_name]=_prop
	...
	attr_name=C;_prop_single_T,_prop_double_T,_prop=double.property_group(attr_name,name='Kappa',get=_kappa_get,set=_kappa_set,translation_context=_C);_annotations_dict[double.eval_prop_single_name(name=attr_name)]=_prop_single_T;_annotations_dict[double.eval_prop_double_name(name=attr_name)]=_prop_double_T;_properties_dict[attr_name]=_prop
	def _draw(self,context:Context,layout:UILayout):col=layout.column(align=True);double.properties_draw(self,A,context,col);double.properties_draw(self,B,context,col);double.properties_draw(self,C,context,col)
	...
	return type(_C,(PropertyGroup,),{_D:_annotations_dict,_E:_draw,_F:_impl_as_array,**_properties_dict})
