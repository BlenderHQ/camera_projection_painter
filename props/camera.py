...
class CameraProps(PropertyGroup):
	...
	active_bind_index:IntProperty(default=0,update=_active_bind_index_update,options={'HIDDEN','SKIP_SAVE'},translation_context=_A,name='Active',description='Active bind history index')
	...
	_sensor_single_T,_sensor_double_T,sensor=intern.double.property_group(_J,get=_cb_get_sensor,set=_cb_set_sensor,precision=constants.IEEE754.FLT_DIG,min=constants.CAMERA.SENSOR.MIN,soft_max=constants.CAMERA.SENSOR.SOFT_MAX,translation_context=_A,name=_K,description='The size of the camera sensor in millimeters, taking into account the larger side of the binded image');sensor_single:_sensor_single_T;sensor_double:_sensor_double_T;_skew_single_T,_skew_double_T,skew=intern.double.property_group('skew',default=.0,soft_min=-1.,soft_max=1.,subtype=_I,translation_context=_A,name='Millimeters Skew',description='Horizontal camera skew in millimeters');skew_single:_skew_single_T;skew_double:_skew_double_T
	...
	_principal_x_mm_single_T,_principal_x_mm_double_T,principal_x_mm=intern.double.property_group(_O,get=_cb_get_principal_x_mm,set=_cb_set_principal_x_mm,translation_context=_A,subtype=_G,name='Millimeters Principal X',description='Deviation of the camera principal point X in millimeters',**_principal_kwargs);principal_x_mm_single:_principal_x_mm_single_T;principal_x_mm_double:_principal_x_mm_double_T
	...
	_principal_y_mm_single_T,_principal_y_mm_double_T,principal_y_mm=intern.double.property_group(_P,get=_cb_get_principal_y_mm,set=_cb_set_principal_y_mm,translation_context=_A,subtype=_G,name='Millimeters Principal Y',description='Deviation of the camera principal point Y in millimeters',**_principal_kwargs);principal_y_mm_single:_principal_y_mm_single_T;principal_y_mm_double:_principal_y_mm_double_T
...
def create_props_camera()->CameraProps:register_class(BindImageHistoryItem);CameraProps.__annotations__['bind_history']=CollectionProperty(type=BindImageHistoryItem,name='Bind History',description='Images that were once binded to this camera');register_class(intern.rc_xmp.RC_MetadataXMP_Props);CameraProps.__annotations__['rc_metadata_xmp_props']=PointerProperty(type=intern.rc_xmp.RC_MetadataXMP_Props,name='RC Metadata XMP',description='Reality Capture "Metadata XMP" properties');return CameraProps