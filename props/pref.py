...
class Preferences(AddonPreferences):
	...
	def draw(self,context:Context):
		...
		match self.tab:
			...
			case'DEV':bhqab.utils_ui.template_developer_extras_warning(context,layout);layout.prop(self,_Z);layout.prop(self,_b);layout.operator(operator=ops.update_manual.CPP_OT_update_manual.bl_idname)