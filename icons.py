...
DATA_ICON_NAMES='aa','appearance','bind','calibration','cleanup_small','credits','dataset','double_precision','export_cameras','export_reality_capture','export','facing_back','facing_front','github','ignore_extension','ignore_letter_case','image','import_cameras','import_image','import_images','import_scene','import','info','inspection','keymap','lens_distortion','license','links','location','outline_checker','outline_fill','outline_lines','patreon','preferences','prv_size_large','prv_size_normal','readme','reality_capture','rotation','setup_context','single_precision','tooltip_fixed','tooltip_floating','tooltip_static','transform','ui','unit_mm','unit_px','update','use_cam_name','use_camera_name','use_image_filepath','viewport','youtube'
