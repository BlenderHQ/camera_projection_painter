...
import bpy
from bpy.types import Area,Context,Region,Space
...
def iter_area_regions(*,area:Area,region_type:str=_B)->None:
	for region in area.regions:
		region:Region
		if region.type==region_type:yield region
...
def tag_redraw_all_regions(*,area_type:str=_A,region_type:str=_B):
