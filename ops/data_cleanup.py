...
class CPP_OT_data_cleanup(metaclass=common.SetupContextOperator):
	bl_idname='cpp.data_cleanup';bl_label='Data Cleanup';bl_description='Cleanup existing data';options={'INTERNAL'};bl_translation_context=_A;cleanup_data:BoolProperty(translation_context=_A,name='Cleanup Data',description='Delete object, mesh, material, texture, light and camera data-blocks');cleanup_images:BoolProperty(translation_context=_A,name='Cleanup Images',description='Delete all image data-blocks')
