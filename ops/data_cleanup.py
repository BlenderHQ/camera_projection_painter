...
class CPP_OT_data_cleanup(metaclass=common.SetupContextOperator):
	bl_idname='cpp.data_cleanup';bl_label=_B;bl_translation_context=_A;options={'REGISTER'};cleanup_data:BoolProperty(translation_context=_A,name=_B,description='Delete object, mesh, material, texture, light and camera data-blocks');cleanup_images:BoolProperty(translation_context=_A,name='Cleanup Images',description='Delete all image data-blocks')
