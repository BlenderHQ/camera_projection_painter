...
class CPP_OT_pref_show(Operator):
	bl_idname='cpp.pref_show';bl_label='Show Preferences';bl_description='Camera Projection Painter user preferences';bl_translation_context=_A;bl_options={'REGISTER'};shortcut:EnumProperty(items=(('NONE','',''),(_B,'','')),default='NONE',options={'HIDDEN','SKIP_SAVE'})
